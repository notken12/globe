...
// LIGHTS
const
    light_amb = new THREE.AmbientLight(16777215, 0.7),
    light_spot_1 = new THREE.SpotLight(2197759, 40, 15, 0.2, 0, 0.9),
    light_spot_2 = new THREE.SpotLight(16018366, 2, 75, .5, 0, 1.25),
    light_dir = new THREE.DirectionalLight(11124735, 5);

light_spot_1.position.set(parentContainer.position.x - 2.5 * GLOBE_RADIUS, 70, 20); //.multiplyScalar(t);
...
const animate = () => {
    ...
    group.quaternion.set(newRot.x + groupCameraRotD.x, newRot.y + groupCameraRotD.y, newRot.z + groupCameraRotD.z, newRot.w + groupCameraRotD.w)
